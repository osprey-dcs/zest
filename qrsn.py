...
def qrpcb(board,stringin,x0,y0,quiet_zone=2,stepnm=10*25400,layer='F.Silkscreen'):
...
#    parser.add_argument(dest='project', help='project name (used in saved gerber file name)')
    ...
    parser.add_argument('-keeppcb', dest='keeppcb',action='store_true',help='keep the pcb file')
...
#        qrpcb(board=board,stringin='https://gitlab.com/lbl-boards/zest commit:%s SN:%03d'%(gitcommit8,sn),x0=80000000,y0=-158000000,stepnm=15*25400,layer='B.Silkscreen')
        ...
        print(stringin)
        qrpcb(board=board,stringin=stringin,x0=90000000,y0=-203000000,stepnm=13*25400,layer='F.Silkscreen',quiet_zone=clargs.quiet)
